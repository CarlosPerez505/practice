...
const Hero = () => {
    return (
        <div
            id="hero"
            className="flex items-center justify-center h-screen w-full bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-white relative overflow-hidden"
            style={{ backgroundImage: `url(${abstractTravel})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
            <div className="absolute inset-0 bg-black bg-opacity-60"></div>
            <div className="relative text-center p-6">
                <h1 className="text-6xl font-extrabold mb-4 text-white drop-shadow-lg">The Red Palm Project</h1>
                <p className="text-2xl mb-6 max-w-2xl mx-auto text-white drop-shadow-lg">
